...
## Installation
1. Installiere die Browser-Erweiterung **Tampermonkey** oder **Violentmonkey**.
...
Hinweis:
Dieses Skript ist ein Community-Projekt und nutzt die API/Daten von cashback-optimizer.de.
